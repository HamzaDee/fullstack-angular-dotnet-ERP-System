...
import { VoucheriterationRoutes } from './voucher-iteration.routing.module';
...
@NgModule({
  declarations: [
    VoucheriterationlistComponent,
    VoucheriterationformComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    SharedPrimengModule,
    RouterModule.forChild(VoucheriterationRoutes)
  ]
})
export class AppVoucheriterationModule { }
