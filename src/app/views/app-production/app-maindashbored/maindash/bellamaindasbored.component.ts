...
import { MainDashService } from '../maindashbored.service';

@Component({
  selector: 'app-bellamaindasbored',
  templateUrl: './bellamaindasbored.component.html',
  styleUrl: './bellamaindasbored.component.scss'
})
export class BellamaindasboredComponent implements OnInit {
  public Data: any;
  ...
  constructor(
      ...
      private service: MainDashService,
    ...
    SetTitlePage() {
        this.TitlePage = this.translateService.instant('MainDashForm');
