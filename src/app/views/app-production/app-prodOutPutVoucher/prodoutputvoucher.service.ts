...
export class ProdoutputVoucherService {
  ...
  constructor(
    ...
    return this.http.get(`${environment.apiURL_Main + '/api/ProductionOutPutVoucher/InvVouchersList/'
    ...
    if (opType == 'Show')
        {
          return this.http.get(`${environment.apiURL_Main + '/api/ProductionOutPutVoucher/ShowInvVoucher/' + this.jwtAuth.getLang() 
        ...
        return this.http.get(`${environment.apiURL_Main + '/api/ProductionOutPutVoucher/EditInvVoucher/' + this.jwtAuth.getLang() 
        + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId() + '/' + voucherId + '/' + voucherTypeNo} `)
        .pipe(
          catchError(this.handleError)
        )
        ...
        return this.http.get(`${environment.apiURL_Main + '/api/ProductionOutPutVoucher/AddInvVoucher/' + this.jwtAuth.getLang() 
    ...
    return this.http.get(`${environment.apiURL_Main + '/api/ProductionOutPutVoucher/GetInvSerialVoucher/'
    ...
    public SaveOutputVoucher(post): Observable<any> {    
        ...
        return this.http.post<any>(`${environment.apiURL_Main + '/api/ProductionOutPutVoucher/SaveProdOutputVoucher/'
    ...
    public GetProdMaterialItems(Id): Observable<any> {    
    return this.http.get(`${environment.apiURL_Main + '/api/ProductionOutPutVoucher/GetProdMaterialItems/'
    ...
    public PostInvVoucher(voucherId): Observable<any> {
      const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) };
      var urlDelete = `${environment.apiURL_Main + '/api/ProductionOutPutVoucher/PostInvVoucher/' + voucherId +'/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId()}`;
      return this.http.post<any>(urlDelete,'',httpOptions)
        .pipe(
          catchError(this.handleError)
        );
