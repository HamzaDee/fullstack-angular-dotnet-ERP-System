...
@Component({
  ...
  templateUrl: './productivity-list.component.html',
  styleUrls: ['./productivity-list.component.scss']
})
export class ProductivityListComponent implements OnInit {
  public Data: any;
  screenId:number = 189;
  exportData: any[];
  custom:boolean;
  ...
  SetTitlePage() {
    this.TitlePage = this.translateService.instant('ProductivityList');
  ...
  refreshInventoryReportTable(data) {
    this.Data = data;
  ...
  exportExcel() {
    import("xlsx").then(xlsx => {
      ...
      this.saveAsExcelFile(excelBuffer, "Productivity List", ".xlsx");
    });
  }
