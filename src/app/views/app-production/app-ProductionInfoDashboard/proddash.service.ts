...
export class ProdDashboredService {
  ...
  public GetDashboredInfo(countryId,agentId,itemId,year): Observable<any> {
    debugger
    return this.http.get(`${environment.apiURL_Main + '/api/ProductionReports/GetDashboredInfo/'
      + this.jwtAuth.getLang() + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId() + '/' + countryId + '/' + agentId + '/' + year  + '/' + itemId} `)
      .pipe(
        catchError(this.handleError)
      )
  }

  public GetDashboredForm(): Observable<any> {
    debugger
    return this.http.get(`${environment.apiURL_Main + '/api/ProductionReports/GetDashboredForm/'
  ...
  public GetSalesAndForecastingAndWinRate(itemId): Observable<any> {
    debugger
    return this.http.get(`${environment.apiURL_Main + '/api/ProductionReports/GetSalesAndForecastingAndWinRate/'
      +  itemId} `)
      .pipe(
        catchError(this.handleError)
      )
