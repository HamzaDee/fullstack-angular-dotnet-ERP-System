...
import { MarketMangerRoutingModule } from './marketmanger-routing.module'; 
...
@NgModule({
  declarations: [
    MmangerformComponent,
    MmangerlistComponent,
  ...
  imports: [
    ...
    RouterModule.forChild(MarketMangerRoutingModule)
  ]
})
export class MmangerModule { }
