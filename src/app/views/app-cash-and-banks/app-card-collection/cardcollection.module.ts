...
import { CardscollectionRoutingModule } from './cardcollection-routing.module';
...
@NgModule({
  declarations: [
    CardscollectionlistComponent,
    CardscollectionformComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild(CardscollectionRoutingModule)
  ]
})
