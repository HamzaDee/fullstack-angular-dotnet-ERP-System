...
import { ProcOutcheqListRoutingModule } from './procoutgoingcheq-routing.module';
...
@NgModule({
  declarations: [
    ProcessoutgoingcheqListComponent,
    ProcessoutgoingcheqFormComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild(ProcOutcheqListRoutingModule)
  ]
})
export class ProcOutcheqModule { }
