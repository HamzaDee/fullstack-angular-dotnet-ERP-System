...
import { TransfervoucherRoutingModule } from './transfervoucher-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    AppSearchModule,
    RouterModule.forChild(TransfervoucherRoutingModule)
  ]
})
export class TransferVoucherModule { }
