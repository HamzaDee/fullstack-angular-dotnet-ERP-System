...
import { BeginingchequesRoutingModule } from './beginingcheques-routing.module';
...
@NgModule({
  declarations: [
    BeginingchequesListComponent,
    BeginingchequesFormComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    AppSearchModule,
    RouterModule.forChild(BeginingchequesRoutingModule)
  ]
})
export class BeginingchequesModule { }
