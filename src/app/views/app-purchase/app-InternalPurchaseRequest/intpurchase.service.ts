...
export class IntPurchaseRequestService {
  ...
  public SavePurchaseRequest(post): Observable<any> {
    ...
    return this.http.post<any>(`${environment.apiURL_Main + '/api/InternalPurReq/SavePurchaseRequest/'
  ...
  public IfExistVoucher(VoucherTypeId, VoucherNo): Observable<any> {
    return this.http.get(`${environment.apiURL_Main + '/api/InternalPurReq/CheckVoucherNo/' + this.jwtAuth.getCompanyId() 
      ...
      public DeleteVoucher(voucherId): Observable<any> {
        const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) };
        var urlDelete = `${environment.apiURL_Main + '/api/InternalPurReq/DeletePueRequest/' + voucherId +'/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId()}`;
  ...
  public GetSerialVoucher(serialType, voucherTypeId, VoucherCategory, year, month): Observable<any> {
    debugger
    return this.http.get(`${environment.apiURL_Main + '/api/InternalPurReq/GetPueRequestVoucher/'
  ...
  public GetInitailPurRequest(voucherId, opType): Observable<any> {
    if(voucherId > 0){
      if(opType == 'Copy'){
        return this.http.get(`${environment.apiURL_Main + '/api/InternalPurReq/CopyPurRequestVoucher/' + this.jwtAuth.getLang() 
        ...
        .pipe(
          ...
          return this.http.get(`${environment.apiURL_Main + '/api/InternalPurReq/ShowPurchaseRequestForm/' + this.jwtAuth.getLang() 
        ...
        return this.http.get(`${environment.apiURL_Main + '/api/InternalPurReq/GetPurchaseRequestFormById/' + this.jwtAuth.getLang() 
        + '/' + voucherId + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId()} `)
        .pipe(
          catchError(this.handleError)
        )
      ...
      return this.http.get(`${environment.apiURL_Main + '/api/InternalPurReq/AddPurchaseRequestForm/' + this.jwtAuth.getLang() 
      + '/' + voucherId + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId()} `)
        .pipe(
          catchError(this.handleError)
        )
...
public GetUnitId(ItemId): Observable<any> {
  debugger
  return this.http.get(`${environment.apiURL_Main + '/api/InternalPurReq/GetUnitId/' + ItemId }`)
    .pipe(
      catchError(this.handleError)
    )    
}
