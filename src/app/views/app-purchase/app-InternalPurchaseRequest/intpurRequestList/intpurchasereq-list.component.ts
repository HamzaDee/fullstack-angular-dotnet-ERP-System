...
@Component({
  selector: 'app-intpurchasereq-list',
  templateUrl: './intpurchasereq-list.component.html',
  styleUrl: './intpurchasereq-list.component.scss'
})
export class IntpurchasereqListComponent implements OnInit {
 ...
 lang:string;
  ...
  constructor
            (
              ...
              private PRService: IntPurchaseRequestService,
  ...
  SetTitlePage() {
    this.TitlePage = this.translateService.instant('IntpurchasereqList');
...
debugger
  ...
  OpenDetailsForm(id: any) {
    ...
    this.router.navigate(['InternalPurchaseRequest/ntpurchasereqForm']);
  }
  ...
  exportPdf() {
    ...
    const Title = currentLang == "ar" ? "قائمة  طلبات الشراء الداخلية" : "Internal Purchase Request List";
