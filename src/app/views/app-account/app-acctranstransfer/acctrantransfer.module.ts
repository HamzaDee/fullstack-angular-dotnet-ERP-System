...
import { AccTranTransferRoutes } from './acctrantransfer-routing.module';
...
@NgModule({
  declarations: [
    AccTranstransferListComponent,
    AcctranstransferFormComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild(AccTranTransferRoutes)
  ]
})
export class AppTransTransferModule { }