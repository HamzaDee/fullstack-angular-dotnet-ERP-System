...
import { ReturnServiceinvoiceRoutes } from './app-returnserviceinvoice.routing.module';
...
@NgModule({
    declarations: [
        ServicereturnFormComponent,
        ServicereturnListComponent,
    ],
    imports: [
      CommonModule,
      FormsModule,
      ...
      RouterModule.forChild(ReturnServiceinvoiceRoutes)
    ]
  })
  export class AppReturnServiceInvoiceModule { }