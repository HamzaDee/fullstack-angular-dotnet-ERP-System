...
export class AppServiceInvoiceService {
  ...
  public SaveServiceInvoice(post): Observable<any> {
    ...
    return this.http.post<any>(`${environment.apiURL_Main + '/api/ServicesInv/SaveServiceInvoice/'
  ...
  formatCurrency(value: number, decimalPlaces: number): string {
    ...
    public PostServiceInvoice(voucherId): Observable<any> {
      const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) };
      var urlDelete = `${environment.apiURL_Main + '/api/ServicesInv/PostServiceInvoice/'  + voucherId + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId() }`;
    ...
    public DeleteServiceInvoice(voucherId): Observable<any> {
      const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) };
      var urlDelete = `${environment.apiURL_Main + '/api/ServicesInv/DeleteServiceInvoice/'  + voucherId + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId() }`;
      return this.http.post<any>(urlDelete,'',httpOptions)
        .pipe(
          catchError(this.handleError)
        );
  ...
  public GetInitailServiceInvoice(voucherId, opType): Observable<any> {
    ...
    if(voucherId > 0){
      if(opType == 'Copy'){
        return this.http.get(`${environment.apiURL_Main + '/api/ServicesInv/CopyServiceInvoice/' + this.jwtAuth.getLang() 
        ...
        return this.http.get(`${environment.apiURL_Main + '/api/ServicesInv/ReverseServiceInvoice/' + this.jwtAuth.getLang() 
        + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId() + '/' + voucherId} `)
        .pipe(
          catchError(this.handleError)
        )
        ...
        return this.http.get(`${environment.apiURL_Main + '/api/ServicesInv/ShowServiceInvoice/' + this.jwtAuth.getLang() 
        + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId() + '/' + voucherId} `)
        .pipe(
          catchError(this.handleError)
        )
        ...
        return this.http.get(`${environment.apiURL_Main + '/api/ServicesInv/EditServiceInvoice/' + this.jwtAuth.getLang() 
        + '/' + this.jwtAuth.getCompanyId() + '/' + this.jwtAuth.getUserId() + '/' + voucherId} `)
        .pipe(
          catchError(this.handleError)
        )
      ...
      return this.http.get(`${environment.apiURL_Main + '/api/ServicesInv/AddServiceInvoice/' + this.jwtAuth.getLang() 
  ...
  public GetValidVoucherNo(VoucherNo, VoucherTypeId): Observable<any> {
    debugger
    return this.http.get(`${environment.apiURL_Main + '/api/ServicesInv/IsValidVoucherNo/' + this.jwtAuth.getCompanyId() + '/' + VoucherNo + '/' + VoucherTypeId}`)
      .pipe(
        catchError(this.handleError)
      )    
  }
