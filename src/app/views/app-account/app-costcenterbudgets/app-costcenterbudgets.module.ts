...
import { CostcenterbudgetsRoutes } from './app-costcenterbudgets-routing.module';
...
@NgModule({
  declarations: [
    CostcenterbudgetsListComponent,
    CostcenterbudgetsFormComponent,
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild(CostcenterbudgetsRoutes)
  ]
})
export class AppCostcenterbudgetsModule { }
