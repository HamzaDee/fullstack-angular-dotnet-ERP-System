...
@Component({
  selector: 'app-studentsnewinvoices',
  templateUrl: './studentsnewinvoices.component.html',
  styleUrl: './studentsnewinvoices.component.scss'
})
export class StudentsnewinvoicesComponent {
  showLoader: boolean;
