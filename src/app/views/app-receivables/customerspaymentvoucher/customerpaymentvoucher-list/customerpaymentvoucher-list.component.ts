...
@Component({
  ...
  templateUrl: './customerpaymentvoucher-list.component.html',
...
export class CustomerpaymentvoucherListComponent implements OnInit {
  ...
  SetTitlePage() {
    this.TitlePage = this.translateService.instant('CustpaymentvoucherList');
    this.title.setTitle(this.TitlePage);
  }

  formatCurrency(value: number, decimalPlaces: number): string {
    return this.cusPaymentvoucherService.formatCurrency(value, decimalPlaces);
  }
  ...
  GetCustPaymentVoucherList() {
    ...
    setTimeout(() => {
      this.cusPaymentvoucherService.GetCustPaymentVoucherList().subscribe(result => {
        ...
        if (currentLang == "ar") {
          this.refresCustomerpaymentvoucherArabic(this.tabelData);
        }
        else {
          this.refreshCustomerpaymentvoucherEnglish(this.tabelData);
        }
  ...
  PostEntryVoucher(id: any) {
    Swal.fire({
      ...
      if (result.value) {
        this.cusPaymentvoucherService.PostCustPaymentVoucher(id).subscribe((result) => {
          if (result.isSuccess) {
  ...
  OpenDetailsForm(id: any) {
    ...
    this.router.navigate(['CustomerPaymentVoucher/CustpaymentvoucherForm']);
  }
  ...
  AddCustomerPaymentVoucherForm(id: any) {
    this.routePartsService.GuidToEdit = id
  ...
  exportPdf() {
    ...
    const Title = currentLang == "ar" ? "قائمة سند صرف العملاء" : "Customer Payment Voucher List";
