...
@Component({
  selector: 'app-disassemblyitemss-list',
  templateUrl: './disassemblyitemss-list.component.html',
  styleUrl: './disassemblyitemss-list.component.scss'
})
export class DisassemblyitemssListComponent implements OnInit {
  ...
  {
    this.SetTitlePage();
    this.GetDisAssemblyitemsList();
    this.getFavouriteStatus(this.screenId);
  }
  
  SetTitlePage() {
    this.TitlePage = this.translateService.instant('DisAssemblyitemsList');
    this.title.setTitle(this.TitlePage);
  }

  GetDisAssemblyitemsList() {
    debugger
  ...
  OpenDetailsForm(id: any) {
    ...
    this.router.navigate(['DisAssemblyItems/DisAssemblyitemsForm']);
  }
  ...
  exportPdf() {
    ...
    if(currentLang == "ar"){
       head = [[' المستودع','  الكمية',' الوحده',' المادة المفككة',' تاريخ السند',' رقم السند']]    }
    else{
       head = [['Store','Quantity','Unit','Dis Assembly Item',' Voucher Date','Voucher Number']]
    }
    ...
    let Title = currentLang == "ar" ? "قائمة المواد المفككة" : "Dis Assembly Items List";
