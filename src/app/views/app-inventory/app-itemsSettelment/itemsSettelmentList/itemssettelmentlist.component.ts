...
@Component({
  selector: 'app-itemssettelmentlist',
  templateUrl: './itemssettelmentlist.component.html',
  styleUrl: './itemssettelmentlist.component.scss'
})
export class ItemssettelmentlistComponent implements OnInit {
  ...
  constructor ( private title: Title,
    ...
    SetTitlePage() {
      this.TitlePage = this.translateService.instant('ItemssettelmentList');
...
/*       setTimeout(() => {
 */
        this.serv.GetItemsSettelmentVoucherList(this.voucherTypeEnum).subscribe(result => {
          debugger
...
/*       }); */
    ...
    OpenDetailsForm(id: any) {
      ...
      this.router.navigate(['ItemsSettelment/ItemssettelmentForm']);
    }
  
    AddSettelementVoucherForm(id: any) {
      this.routePartsService.GuidToEdit = id
    ...
    EditSettelementVoucherForm(id: any) {
      this.routePartsService.GuidToEdit = id
