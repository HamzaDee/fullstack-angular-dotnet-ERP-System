...
@Component({
  selector: 'app-invreceiptvoucher-list',
  templateUrl: './invreceiptvoucher-list.component.html',
  styleUrls: ['./invreceiptvoucher-list.component.scss']
})
export class InvreceiptvoucherListComponent implements OnInit {
  ...
  constructor(private title: Title,
    ...
    private RecInvService: ReceiptStockVoucherService,
  ...
  SetTitlePage() {
    this.TitlePage = this.translateService.instant('InvreceiptvoucherList');
  ...
  GetPurchaseInvoiceList() {
    ...
    setTimeout(() => {
      this.RecInvService.GetReceiptItemsVoucherList().subscribe(result => {
        debugger
  ...
  DeletePurchaseInvoice(Id : any) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.RecInvService.DeleteReceiptItemsVoucher(Id).subscribe((results) => {
          debugger
  ...
  ShowDetailsOnly(id: any) {
    ...
    this.router.navigate(['ReceiptItemsVoucher/AddInvVoucher']);
  }
  ...
  refreshInvreceiptvoucherArabic(data : any) {
    debugger
    this.data = data;
  ...
  refreshInvreceiptvoucherEnglish(data : any) {
    debugger
    this.data = data;
    this.exportData = this.data.map(x => {
  ...
  exportPdf() {
    ...
    let Title = currentLang == "ar" ?"قائمة سندات الأستلام " : "Receipt Items Voucher List";
