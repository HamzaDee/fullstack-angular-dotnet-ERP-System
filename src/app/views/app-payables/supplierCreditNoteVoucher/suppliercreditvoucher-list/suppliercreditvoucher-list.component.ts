...
@Component({
  selector: 'app-suppliercreditvoucher-list',
  templateUrl: './suppliercreditvoucher-list.component.html',
  styleUrls: ['./suppliercreditvoucher-list.component.scss']
})
export class SuppliercreditvoucherListComponent implements OnInit {
  ...
  formatCurrency(value: number, decimalPlaces: number): string {
    ...
    return this.supCreditvoucherService.formatCurrency(value, decimalPlaces);
  }
  ...
  GetCreditNoteVoucherList() {
    ...
    setTimeout(() => {
      this.supCreditvoucherService.GetSuppCreditNoteVoucherList().subscribe(result => {
        ...
        debugger
        if (currentLang == "ar") {
          this.refresSuppliercreditvoucherArabic(this.tabelData);
        }
        else {
          this.refreshSuppliercreditvoucherEnglish(this.tabelData);
        }
  ...
  PostEntryVoucher(id: any) {
    Swal.fire({
      ...
      if (result.value) {
        this.supCreditvoucherService.PostSuppCreditNoteVoucher(id).subscribe((result) => {
          if (result.isSuccess) {
  ...
  OpenDetailsForm(id: any) {
    ...
    this.router.navigate(['SupplierCreditNoteVoucher/SuppCreditVoucherForm']);
  }
  ...
  AddSupplierCreditVoucherForm(id: any) {
    this.routePartsService.GuidToEdit = id
  ...
  refresSuppliercreditvoucherArabic(data) {
    debugger
    this.data = data;
  ...
  refreshSuppliercreditvoucherEnglish(data) {
    debugger
    this.data = data;
    this.exportData = this.data.map(x => {
  ...
  exportExcel() {
    ...
    import("xlsx").then(xlsx => {
      ...
      worksheet[valueCell] = { t: 'n', v: totalValue };
  ...
  exportPdf() {
    ...
    const Title = currentLang == "ar" ? "قائمة اشعارات دائن  موردين" : "Supplier Credit  Voucher List";
